...
public class Constantes {
	...
	public static final String POSTAR_REDIRECT = "redirect:/postar";
	
	public static final String LOGIN_INDEX = "login/index";
	public static final String HOME_INDEX = "home/index";
	
	public static final String POSTAR_INDEX = "postar/index";
	public static final String POSTAR_ETIQUETA = "postar/etiqueta";
	public static final String POSTAR_FORM = "postar/form-malote";
